...
finalFatal <- fatal2 %>%
  left_join(county, by = c('State Name', 'County Name'))

#Creating choropleth map
ggplot(finalFatal, aes(x = long, y = lat)) + 
  geom_polygon(aes(group = group, fill = totalFatal)) + xlab("Longitude") + ylab("Latitude") + ggtitle("Number of Deaths by County in the United States")
```
